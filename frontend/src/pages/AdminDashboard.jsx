...
const AdminDashboard = () => {
  ...
  //   ]);
    ...
    //   { id: 1, name: 'Alice Cooper', email: 'alice@example.com', mobileNumber:"9875454547", role: 'Customer', joined: '2024-12-20', orders: 5, status: 'Active' },
    //   { id: 2, name: 'Bob Martin', email: 'bob@example.com', mobileNumber:"9876543210", role: 'Customer', joined: '2024-12-19', orders: 3, status: 'Active' },
    //   { id: 3, name: 'Carol White', email: 'carol@example.com', mobileNumber:"9845649865", role: 'Customer', joined: '2024-12-18', orders: 0, status: 'Active' },
    //   { id: 4, name: 'David Lee', email: 'david@example.com', mobileNumber:"8765988745", role: 'Admin', joined: '2024-12-17', orders: 8, status: 'Active' },
    //   { id: 5, name: 'Emma Wilson', email: 'emma@example.com', mobileNumber:"8654789856", role: 'Customer', joined: '2024-12-16', orders: 12, status: 'Active' },
    //   { id: 6, name: 'Frank Thomas', email: 'frank@example.com', mobileNumber:"9454568432", role: 'Customer', joined: '2024-12-15', orders: 2, status: 'Inactive' },
    // ]);
